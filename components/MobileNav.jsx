  ...
  return (
    <section className="md:hidden w-screen  h-screen flex pt-16 justify-center side-menu sticky top-0 z-10 left-0">
      <svg
        version="1.1"
        onClick={hideNav}
        className="close absolute top-0 left-0 cursor-pointer"
      ...
      <ul className=" leading-[500%]">
        ...
        <Link href="/collections">
          <li className="flex gap-x-4 items-center">
            ...
            <p className="top-chart-text ml-4">My collections</p>
          </li>
        </Link>
        <Link href="/viewchart">
          <li className="flex gap-x-4 items-center">
            ...
            <p className="top-chart-text ml-4">Radio</p>
          </li>
        </Link>
        <li className="flex gap-x-4 items-center">
          <svg
          ...
          <p className="top-chart-text ml-4">Music videos</p>
        </li>
        <li className="flex gap-x-4 items-center">
          <svg
            width="22"
          ...
          <p className="top-chart-text ml-4">Profile</p>
        </li>
        <li className="flex gap-x-4 items-center">
          <svg
            width="22"
          ...
          <p className="top-chart-text ml-4">Log out</p>
        </li>
      </ul>
    </section>
  );
